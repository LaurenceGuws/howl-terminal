...
- This interruption rule is verified across tabulation CSI (`I`/`Z`), DEC private mode CSI (`?25`/`?7`), and absolute-position CSI (`G`/`d`) in replay, parity, and runtime integration tests.
