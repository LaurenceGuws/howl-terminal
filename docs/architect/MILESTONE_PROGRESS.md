...
| `M9` Multi-Host Confidence | `active` | `app_architecture/authorities/M9_FOUNDATION.md` | Architect-owned planning phase. Define cross-host conformance contract, evidence protocol, and queue gates before publishing implementation tickets. |
