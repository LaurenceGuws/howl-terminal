...
| `M10` Best-in-Class Embedded Engine | `active` | `app_architecture/authorities/M10_FOUNDATION.md` | M10-A/B/C are complete: doctrine (`app_architecture/contracts/QUALITY_DOCTRINE.md`), evidence protocol+fixtures (`docs/review/m10/M10_B_EVIDENCE_PROTOCOL.md`, `docs/review/m10/M10_STRESS_FIXTURES.md`), and bounded execution queue publication (`docs/engineer/ACTIVE_QUEUE.md`). M10-D freeze cadence remains pending. |
