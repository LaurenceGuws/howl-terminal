...
| `M3` History and Selection | `active` | `app_architecture/authorities/MILESTONE.md` | Scope opened. First gate is history/selection coordinate and reset-policy authority, followed by bounded history storage and selection execution slices. |
