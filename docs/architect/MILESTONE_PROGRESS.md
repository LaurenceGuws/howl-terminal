...
| `M6` Snapshot and Replay Contracts | `active` | `app_architecture/authorities/M6_FOUNDATION.md` | M6-A contract closure complete (SNAPSHOT_REPLAY.md published). Next: M6-B snapshot surface, M6-C replay evidence, M6-D freeze handoff. |
