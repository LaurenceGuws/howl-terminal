...
| `M7` Performance and Memory Discipline | `done` | `app_architecture/authorities/M7_FOUNDATION.md` | M7 frozen. Doctrine, audit, protocol, fixtures, and baseline evidence (`M7-BL-001`..`M7-BL-005`) are complete. F1/F2/F2B/F3 specs and reviews accepted. Freeze review: `docs/architect/M7_FREEZE_REVIEW.md`. |
