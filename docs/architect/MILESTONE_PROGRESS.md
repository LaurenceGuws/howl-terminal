...
| `M8` Host Integration Readiness | `done` | `app_architecture/authorities/M8_FOUNDATION.md` | M8 frozen. Contract closure (A), boundary audit (B), validation gates (C), and execution evidence slices (E1/E2) are accepted. Freeze review: `docs/review/m8/M8_FREEZE_REVIEW.md`. |
