...
| `M10` Best-in-Class Embedded Engine | `active` | `app_architecture/authorities/M10_FOUNDATION.md` | Architect-owned planning phase. M10-A doctrine closure is complete (`app_architecture/contracts/QUALITY_DOCTRINE.md`, review: `docs/review/m10/M10_A_DOCTRINE_REVIEW.md`). M10-B evidence protocol and fixture catalog are complete (`docs/review/m10/M10_B_EVIDENCE_PROTOCOL.md`, `docs/review/m10/M10_STRESS_FIXTURES.md`, review: `docs/review/m10/M10_B_PROTOCOL_REVIEW.md`). M10-C queue publication is next. |
