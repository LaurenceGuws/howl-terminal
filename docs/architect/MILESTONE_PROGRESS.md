...
| `M5` Runtime Interface | `active` | `app_architecture/authorities/M5_FOUNDATION.md` | M5-A complete (contract closure: lifecycle matrix in RUNTIME_API.md, conformance tests proving all method-boundary invariants). Proceeding to M5-B interface hardening. |
