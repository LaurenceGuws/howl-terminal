...
| `M10` Best-in-Class Embedded Engine | `active` | `app_architecture/authorities/M10_FOUNDATION.md` | Architect-owned planning phase. Define M10 quality doctrine and evidence expansion protocol before any execution queue publication. |
